...
public class LeerMedi extends JInternalFrame implements ActionListener {

	private GestionDatosMedi gm;

	private JTextArea txtaInscripciones;

	public LeerMedi(GestionDatosMedi gm) {
	...
	public void cargar() throws Exception {
			...
			txtaInscripciones.setText(gm.leerArchivos().toString());
